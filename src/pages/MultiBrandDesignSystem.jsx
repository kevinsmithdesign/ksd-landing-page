  ...
  return (
    <Container>
      <Stack
        textAlign="center"
        maxWidth="800px"
        sx={{ mx: "auto", mt: 8, mb: 4 }}
      >
        <Typography variant="h3" fontWeight="bold" mb={2}>
          Design Once, Brand Everywhere
        </Typography>
        <Typography variant="h6" fontWeight="">
          Architecting a multi‑brand design system at Newfold Digital to unify
          foundations, preserve brand identity, and accelerate delivery across a
          complex portfolio.
        </Typography>
      </Stack>
      ...
      <Stack sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" mb={2}>
          Newfold Digital is the parent company behind a large portfolio of web
          service brands — Bluehost, HostGator, Network Solutions, Web.com,
          Domain.com, Yoast SEO, and many others. This collection of brands
          exists because of years of mergers and acquisitions. Instead of
          building one brand from the ground up, Newfold grew by bringing
          ...
          customer segments, it also introduced significant design and technical
          complexity.
        </Typography>
        <Typography variant="body2" mb={2}>
          Each brand operated independently for years, developing its own design
          language, its own component library, and its own customer experience.
          This autonomy helped brands retain their unique identity but created
          systemic problems at scale:
        </Typography>
      ...
      <Stack sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" mb={2}>
          ...
          What we found was staggering: dozens of variations of buttons, inputs,
          and navigation patterns that solved the same problems in slightly
          different ways.
        </Typography>
        <Typography variant="body2" mb={2}>
          ...
          radius varied wildly. Every brand had reinvented the wheel in its own
          way.
        </Typography>
        <Typography variant="body2">
          This discovery phase gave us both clarity and urgency. The
          inconsistency wasn’t just aesthetic — it slowed delivery, created
          accessibility risks, and fragmented the customer experience. The audit
          became the baseline for unifying foundations without erasing brand
          identity.
        </Typography>
      </Stack>
      ...
      <Stack sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" mb={2}>
          ...
          side of the problem. We interviewed designers, engineers, and product
          managers across the portfolio to hear firsthand where friction slowed
          them down and where fragmentation hurt customers.
        </Typography>
        <Typography variant="body2" mb={2}>
          Customer feedback and support tickets revealed confusion when moving
          between brands: navigation worked differently, checkout flows shifted,
          and accessibility gaps created frustration. Internally, teams
          expressed how much time was wasted reinventing solutions that already
          existed elsewhere.
        </Typography>
        <Typography variant="body2">
          We also benchmarked against other multi‑brand design systems in the
          industry, validating that a token‑first approach with semantic theming
          was the right direction. These research insights ensured our system
          wasn’t just technically elegant — it was rooted in the realities of
          how people built and used products every day.
        </Typography>
      </Stack>
      ...
      <Stack sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" mb={2}>
          ...
          like brand-primary-main or btn-primary-bg , gave values brand meaning.
          Components never touched raw values.
        </Typography>
        <Typography variant="body2">
          The result was a single component library that remained brand‑agnostic
          in code but became brand‑aware at runtime. Teams could migrate
          gradually, starting with high‑leverage components and layering in the
          rest — bridging the gap between vision and reality: one system, many
          voices.
        </Typography>
      </Stack>
      ...
      <Stack sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" mb={2}>
          ...
          prioritized high-impact components first — buttons, inputs, navigation
          — the building blocks that appear across every brand experience.
        </Typography>
        <Typography variant="body2" mb={2}>
      ...
      <Stack mb={4}>
        ...
        >
          <iframe
            src="https://multi-brand-design-system.netlify.app/"
            title="Newfold Design System Demo"
            style={{
              width: "100%",
              height: "600px",
              border: "none",
